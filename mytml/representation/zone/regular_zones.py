...
from mytml.representation.zone.zone import Zone
...
regular_zones = [
    Zone(
        "UPPER",
        lambda angle: match_quadrant(angle, pi / 4),
        upper_quadrant_representation,
    ),
    Zone(
        "LOWER",
        lambda angle: match_quadrant(angle, (5 / 4) * pi),
        lower_quadrant_representation,
    ),
    Zone(
        "LEFT",
        lambda angle: match_quadrant(angle, (3 / 4) * pi),
        left_quadrant_representation,
    ),
    Zone(
        "RIGHT",
        lambda angle: match_quadrant(angle, (7 / 4) * pi),
        right_quadrant_representation,
    ),
]
