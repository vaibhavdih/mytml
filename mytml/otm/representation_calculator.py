from mytml.otm.representation import RepresentationElement
from mytml.diagram import DiagramLimits, DiagramComponent, DiagramComponentOrigin
...
def get_absolute_coordinates(component):
